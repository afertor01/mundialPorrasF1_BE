...
ACHIEVEMENT_DEFINITIONS = [
    ...
    {"slug": "event_grand_chelem", "name": "Grand Chelem", "desc": "Acertar Pole + VR + Ganador.", "icon": "Maximize", "rare": "EPIC", "type": "EVENT"},
    {"slug": "event_civil_war", "name": "Civil War", "desc": "Acertar un 1-2 de compañeros de equipo.", "icon": "Swords", "rare": "RARE", "type": "EVENT"},
    {"slug": "event_tifosi", "name": "Tifosi", "desc": "Ferrari gana en Monza y tú puntúas.", "icon": "Italic", "rare": "RARE", "type": "EVENT"},
